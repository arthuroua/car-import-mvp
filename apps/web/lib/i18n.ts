  ...
  en: {
    ...
    home: {
      ...
      simpleLead: "Enter VIN, lot number, or auction URL.",
        ...
        recentPhotoPending: "Photos pending",
        lead:
    ...
    cars: {
      ...
      quickChip: "Quick catalog",
      quickTitle: "Choose make and model",
      quickLead: "A faster way to jump straight into the brand or model page without scrolling through the full catalog.",
      quickMake: "Make",
      quickModel: "Model",
      quickChooseMake: "Choose make",
      quickChooseModel: "Choose model",
      quickOpenModel: "Open model",
      openSearch: "Open VIN search",
      openAdmin: "SEO admin",
      goBrand: "Open brand",
      openPage: "Open page",
  ...
  uk: {
    ...
    home: {
      ...
      simpleLead: "Введи VIN, номер лота або URL аукціону.",
        ...
        recentPhotoPending: "Фото очікуються",
        lead:
    ...
    cars: {
      ...
      quickChip: "Швидкий каталог",
      quickTitle: "Обери марку та модель",
      quickLead: "Швидкий перехід одразу на сторінку бренду або моделі без прокрутки всього каталогу.",
      quickMake: "Марка авто",
      quickModel: "Модель",
      quickChooseMake: "Обери марку",
      quickChooseModel: "Обери модель",
      quickOpenModel: "Відкрити модель",
      openSearch: "Відкрити VIN-пошук",
  ...
  ru: {
    ...
    home: {
      ...
      simpleLead: "Введите VIN, номер лота или URL аукциона.",
        ...
        recentPhotoPending: "Фото ожидаются",
        lead:
    ...
    cars: {
      ...
      quickChip: "Быстрый каталог",
      quickTitle: "Выберите марку и модель",
      quickLead: "Быстрый переход сразу на страницу бренда или модели без прокрутки всего каталога.",
      quickMake: "Марка авто",
      quickModel: "Модель",
      quickChooseMake: "Выберите марку",
      quickChooseModel: "Выберите модель",
      quickOpenModel: "Открыть модель",
      openSearch: "Открыть VIN-поиск",
